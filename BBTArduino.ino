...
#define USER_SSID                 "BlueBotWifiNetwork"
#define USER_PASSWORD             "BlueBotPassword"
#define USER_MQTT_SERVER         "192.168.1.XXX"
#define USER_MQTT_PORT            1883
#define USER_MQTT_USERNAME        "BlueBotMQTT"
#define USER_MQTT_PASSWORD        "BlueBotMQTTPassword"
#define USER_MQTT_CLIENT_NAME     "BlueBotBlinds"         // Used to define MQTT topics, MQTT Client ID, and ArduinoOTA
...
const char* ssid = "BlueBotWifiNetwork" ;
const char* password = "BlueBotPassword" ;
const char* mqtt_server = "192.168.1.XXX" ;
const int mqtt_port = 1883 ;
const char *mqtt_user = "BlueBotMQTT" ;
const char *mqtt_pass = "BlueBotMQTTPassword" ;
const char *mqtt_client_name = "BlueBotBlinds" ;
